...
})({"giInK":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "bd294c9b11223c91";
"use strict";
...
},{}],"6e34w":[function(require,module,exports) {
...
window["setup"] = function setup() {
    ...
    for(let i = 0; i < 20; i++){
        particles.push(new (0, _particle.Particle)(random(0.1, 1), random(5, 20), (0, _particle.shape).Circle, random(0, 255)));
        particles.push(new (0, _particle.Particle)(random(0.1, 1), random(5, 20), (0, _particle.shape).Square, random(0, 255)));
        particles.push(new (0, _particle.Particle)(random(0.1, 1), random(5, 20), (0, _particle.shape).Triangle, random(0, 255)));
    }
};
...
},{"tweakpane":"cvybH","./particle":"IFDNf"}],"cvybH":[function(require,module,exports) {
...
},{}],"IFDNf":[function(require,module,exports) {
...
class Particle {
    constructor(speed, size, shape, hue){
    ...
    wrapVector(vector, minX, maxX, minY, maxY) {
        if (vector.x < minX) vector.x = maxX;
        else if (vector.x > maxX) vector.x = minX;
        if (vector.y < minY) vector.y = maxY;
        else if (vector.y > maxY) vector.y = minY;
    }
    tick(deltaTime) {
        push();
        colorMode("hsb");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["giInK","6e34w"], "6e34w", "parcelRequire5fbd")

//# sourceMappingURL=index.11223c91.js.map
